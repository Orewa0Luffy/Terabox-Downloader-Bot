...
async def start_command(client: Client, message: Message):
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ❤️🚀", url="https://t.me/Series_Union")
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="https://t.me/Sexy_Boy_Telegram")
    repo69 = InlineKeyboardButton("ʀᴇᴘᴏ 🌐", url="https://t.me/Series_Union")
